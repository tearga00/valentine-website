...
function drawText() {
    ...
    if(frameNumber < 250){
        ...
        context.fillText("Happiest Valentines sa'yo na pinaniwala ulit ako, hindi lang sa konsepto ng araw na to, pero yung kakayahan ko para makapagmahal at bigyang chansa na mahalin ka na rin", canvas.width/2, canvas.height/2);
